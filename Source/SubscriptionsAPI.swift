...
extension CloudAPIClient {
    ...
    /**
        ...
        @return self
    */
    public func fetchSubscriptions(completionHandler: (NSURLRequest?, NSHTTPURLResponse?, Result<[Subscription]>) -> Void) -> Request {
    ...
    */
    public func subscribeTo(feed: Feed, categories: [Category], completionHandler: (NSURLRequest?, NSHTTPURLResponse?, Result<Void>) -> Void) -> Request {
    ...
    public func subscribeTo(subscription: Subscription, completionHandler: (NSURLRequest?, NSHTTPURLResponse?, Result<Void>) -> Void) -> Request {
    ...
    /**
        ...
        POST /v3/subscriptions
    */
    public func updateSubscription(subscription: Subscription, completionHandler: (NSURLRequest?, NSHTTPURLResponse?, Result<Void>) -> Void) -> Request {
    ...
    */
    public func unsubscribeTo(feedId: String, completionHandler: (NSURLRequest?, NSHTTPURLResponse?, Result<Void>) -> Void) -> Request {
